...
public class RestrictedmediaResource extends NuxeoBasedResource {
    final Logger logger = LoggerFactory.getLogger(RestrictedmediaResource.class);
    final static RestrictedmediaClient restrictedmediaClient = new RestrictedmediaClient();
...
//	}
    ...
    public Response create(ServiceContext<PoxPayloadIn, PoxPayloadOut> parentCtx,
        ...
        if (blobUri != null && blobUri.isEmpty() == false) {
       	...
       	result = super.create(parentCtx, resourceMap, ui, xmlPayload); // Now call the parent to finish the restricted media resource POST request
